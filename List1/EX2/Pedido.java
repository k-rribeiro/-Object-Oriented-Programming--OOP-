...
public class Pedido {
    ...
    //metodo para adicionar itens para o pedido(essa estrutura ̩ solicitada pelo enunciado que esteja no metodo abaixo)
    public void adicionarItem(Item item){
        if (qnt < itens.length){
            ...
            System.out.println("nn ̩ possivel adicionar mais itens na lista");
        }
    }
    ...
    public void calculaTotal(){
        ...
        //percorre o array incrementando o pre̤o dos produtos no atributo total
        for (int i = 0; i < qnt; i++){
    ...
    //metodo para exibir todas informa̵̤es do pedido realizado
